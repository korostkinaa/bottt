...
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра КНБ-MP", "Игра в 21", "Своя игра", "Выход"], parent=m_main)
...
m_dz = Menu("ДЗ", buttons=["ДЗ №1", "ДЗ №2", "ДЗ №3", "ДЗ №4", "ДЗ №5", "ДЗ №6", "Выход"], parent=m_main, module="dz")

m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать лису", "Прислать кота", "Прислать анекдот",  "Прислать новости", "Прислать фильм", "Прислать курсы", "Угадай кто?", "Выход"], parent=m_main, module="fun")
